...
function Footer() {
  ...
  return (
    <footer
      className="bg-[var(--bg-secondary)] text-[var(--text-primary)]/70 pt-10 md:pt-12 pb-6"
      ...
      <div className="max-w-[1300px] mx-auto px-4 md:px-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div className="col-span-1 sm:col-span-2 md:col-span-1 text-center md:text-left">
            ...
            <div className="flex gap-2 justify-center md:justify-start">
              <a
                ...
                className="bg-[var(--bg-card)]/10 hover:bg-[#1877F2] hover:scale-110 w-9 h-9 rounded-full flex items-center justify-center text-sm transition-all duration-300"
                title="Facebook"
                aria-label="Facebook"
              >
                <FacebookIcon />
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[var(--bg-card)]/10 hover:bg-gradient-to-tr hover:from-[#FD1D1D] hover:to-[#405DE6] hover:scale-110 w-9 h-9 rounded-full flex items-center justify-center text-sm transition-all duration-300"
                title="Instagram"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[var(--bg-card)]/10 hover:bg-[#1DA1F2] hover:scale-110 w-9 h-9 rounded-full flex items-center justify-center text-sm transition-all duration-300"
                title="Twitter / X"
                aria-label="Twitter"
              >
                <TwitterIcon />
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[var(--bg-card)]/10 hover:bg-[#FF0000] hover:scale-110 w-9 h-9 rounded-full flex items-center justify-center text-sm transition-all duration-300"
                title="YouTube"
                aria-label="YouTube"
              >
                <YouTubeIcon />
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-[var(--text-primary)] text-sm font-bold mb-4 flex items-center justify-center sm:justify-start gap-2">
              <span className="w-1 h-4 bg-[var(--accent-secondary)] rounded-full"></span>
              Acheter
            </h4>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2.5 text-xs">
              <li>
                <Link to="/devenir-vendeur" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-user-plus mr-2"></i>Devenir vendeur
                </Link>
              </li>
              <li>
                <Link to="/guide-vendeur" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-book mr-2"></i>Guide vendeur
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-chart-line mr-2"></i>Tableau de bord
                </Link>
              </li>
              <li>
                <Link to="/certification" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-award mr-2"></i>Certification
                </Link>
              </li>
              <li>
                <Link to="/tarifs" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2.5 text-xs">
              <li>
                <Link to="/service-client" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-headset mr-2"></i>Service client
                </Link>
              </li>
              <li>
                <Link to="/livraison" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-shipping-fast mr-2"></i>Livraison
                </Link>
              </li>
              <li>
                <Link to="/retours" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-undo mr-2"></i>Retours
                </Link>
              </li>
              <li>
                <Link to="/paiement-mobile-money" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
                  <i className="fas fa-mobile-alt mr-2"></i>Paiement Mobile Money
                </Link>
              </li>
              <li>
                <Link to="/a-propos" className="block hover:text-[var(--accent-secondary)] hover:translate-x-1 transition-all duration-200">
        ...
        <div className="border-t border-[var(--border-color)]/80 pt-8 mb-8">
          <div className="max-w-md mx-auto text-center px-2">
            ...
            <p className="text-xs text-[var(--text-primary)]/60 mb-4">Recevez nos offres exclusives et actualités</p>
            ...
            {newsletterSent ? (
              ...
              <form onSubmit={handleNewsletter} className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 bg-[var(--bg-card)]/10 border border-[var(--border-color)] rounded-lg px-4 py-2.5 text-sm text-[var(--text-primary)] placeholder-[var(--text-primary)]/40 outline-none focus:border-[var(--accent-secondary)] transition min-w-0"
                />
                <button
                  type="submit"
        ...
        <div className="border-t border-[var(--border-color)]/80 pt-6 mb-6">
          <p className="text-center text-xs text-[var(--text-primary)]/50 mb-4">Moyens de paiement acceptés</p>
        ...
        <div className="border-t border-[var(--border-color)]/80 pt-6">
          <div className="text-center mb-4">
            <button
              onClick={scrollToTop}
              className="inline-flex items-center gap-1 text-xs text-[var(--text-primary)]/60 hover:text-[var(--accent-secondary)] transition"
          ...
          <p className="text-center text-xs mb-2">
            © {currentYear} <span className="text-[var(--accent-secondary)] font-semibold">AgroAfrica</span> — Fait avec{' '}
            <i className="fas fa-leaf text-green-500"></i> au Cameroun 🇨🇲
          </p>

          <p className="text-center text-[10px] text-[var(--text-primary)]/30 mb-2">Dernière mise à jour : {updatedAt}</p>

          <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-[var(--text-primary)]/50 text-xs">
